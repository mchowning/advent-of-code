...
day1 =
  testGroup
    ...
    [ testGroup
        "fast"
        [ testCase "part 1" $ part1' testInput @?= 514579,
          testCase "part 1 handles duplicates" $ part1' [1010, 1010] @?= 1020100,
          testCase "part 2" $ part2' testInput @?= 241861950
        ]
      -- , testGroup
      --   "slow"
      --   [ testCase "part 1" $ part1 >>= (@?= 252724),
      --     testCase "part 2" $ part2 >>= (@?= 276912720),
      --     testGroup
      --       "property tests"
