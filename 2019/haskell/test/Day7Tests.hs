  ...
  [ testGroup "part 1"
    ...
    , testGroup "example steps" $
      ...
      in [ testCase "example1" $ part1' example1 @?= 43210
         , testCase "example1 max" $ ampTest example1 [4,3,2,1,0] @?= 43210
         , testCase "example2" $ part1' example2 @?= 54321
         , testCase "example2 max" $ ampTest example2 [0..4] @?= 54321
         , testCase "example3" $ part1' example3 @?= 65210
         , testCase "example3 max" $ ampTest example3 [1,0,4,3,2] @?= 65210
         ]
    ]
  , testGroup "part 2"
